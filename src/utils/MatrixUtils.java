...
public class MatrixUtils {
    ...
    /**
     * Алгоритм порядка словаря.
     *
     * Простое объяснение алгоритма:
     * В исходном положении справа налево найдите первый символ, левый сосед
     * которого меньше правого соседа, позиция левого - i.
     * Все, что после i - переставить в обратном порядке.
     * Справа налево найти первое число, что больше array[i].
     * Поменять их местами.
     *
     @param array Массив для перестановки.
     *
     * @return False, если последовательность обратили до первой перестановки, true в противном случае.
     */
